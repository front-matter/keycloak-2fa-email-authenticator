        ...
        public List<ProviderConfigProperty> getConfigProperties() {
                return List.of(
                                ...
                                new ProviderConfigProperty(EmailConstants.EMAIL_PROVIDER_TYPE, "Email Provider",
                                                ...
                                                List.of("KEYCLOAK", "SENDGRID", "AWS_SES", "MAILGUN")
                                ...
                                new ProviderConfigProperty(EmailConstants.AWS_ACCESS_KEY_ID, "AWS Access Key ID",
                                                ...
                                                ProviderConfigProperty.STRING_TYPE, null),
                                new ProviderConfigProperty(EmailConstants.AWS_SECRET_ACCESS_KEY,
                                ...
                                new ProviderConfigProperty(EmailConstants.ENABLE_FALLBACK,
                                                "Enable Fallback to Keycloak SMTP",
                                                "If enabled, falls back to Keycloak SMTP when the primary provider fails.",
                                                ProviderConfigProperty.BOOLEAN_TYPE,
                                                String.valueOf(EmailConstants.DEFAULT_ENABLE_FALLBACK)),
                                ...
                                new ProviderConfigProperty(EmailConstants.SIMULATION_MODE, "Simulation Mode (dev only)",
                                                ...
                                                ProviderConfigProperty.BOOLEAN_TYPE,
                                                String.valueOf(EmailConstants.DEFAULT_SIMULATION_MODE)),
                                new ProviderConfigProperty(EmailConstants.RESEND_COOLDOWN, "Resend Cooldown (seconds)",
                                                ...
                                                ProviderConfigProperty.STRING_TYPE,
                                                String.valueOf(EmailConstants.DEFAULT_RESEND_COOLDOWN)),

                                new ProviderConfigProperty(EmailConstants.MAGIC_LINK_ENABLED, "Magic Link",
                                                "If enabled, the email includes a session-specific link that can complete the OTP step.",
                                                ProviderConfigProperty.BOOLEAN_TYPE,
